...
KEYFRAME_OUTPUT = "Keyframe Output"
...
NO_OP_MAPPING_ARROW_DESCRIPTION = "(This is just an arrow to indicate midi input to keyframe output mapping on the user interface)"
