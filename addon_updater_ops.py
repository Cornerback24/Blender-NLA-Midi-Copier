...
def register(bl_info):
    ...
    updater.user = "Cornerback24"

    # Choose your own repository, must match git name for GitHUb and Bitbucket,
    # for GitLab use project ID (numbers only).
    updater.repo = "Blender-NLA-Midi-Copier"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/Cornerback24/Blender-NLA-Midi-Copier#blender-nla-midi-copier"
    ...
    updater.backup_ignore_patterns = ["__pycache__", ".git", ".idea", ".gitignore"]
    ...
    updater.overwrite_patterns = ["*.png", "*.jpg", "README.md", "LICENSE.txt", "LICENSE", "CHANGELOG.md"]
    ...
    updater.version_min_update = (0, 13, 2)
    ...
    updater.version_max_update = (0, 99, 99)  # None or default for no max.
